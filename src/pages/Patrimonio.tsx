...
const UPGRADE_COSTS: Record<string, number[]> = {
  ...
  psicologia: [0, 25000, 60000, 140000, 300000, 600000, 1200000, 2400000, 4000000, 7000000],
  escola: [0, 20000, 50000, 120000, 250000, 500000, 1000000, 2000000, 3500000, 6000000],
  funcionarios: [0, 30000, 70000, 160000, 350000, 700000, 1400000, 2800000, 4500000, 8000000],
};
...
const UPGRADE_WEEKS: Record<string, number[]> = {
  ...
  psicologia: [0, 2, 2, 3, 4, 5, 6, 8, 10, 12],
  escola: [0, 1, 2, 3, 4, 5, 6, 8, 10, 12],
  funcionarios: [0, 1, 2, 3, 4, 5, 6, 7, 9, 12],
};
